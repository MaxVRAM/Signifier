...
from wtforms import Form, BooleanField, HiddenField, StringField, TextAreaField, widgets, SelectMultipleField, RadioField
import hashlib
import re
import json
import os
...
try:
    app_root = os.path.join(os.environ["SIGNIFIER"], 'site')
except:
    app_root = "/home/pi/Signifier/site"
