...
## Project targets
A. Reliable **non-interactive** audio and LEDs.
B. **Interactive** audio and non-interactive LEDs.
C. Interactive audio, with interactive LEDs controlled by the Raspberry Pi.
D. Features of target C, with network communication via WiFi and cellular network to an online server.
...
## Hardware
### Computation
- [RPi](https://au.rs-online.com/web/p/raspberry-pi/1822096)
